...
JUDGE_V2_PATH = os.path.join(os.path.dirname(__file__), "..", "prompts", "judge_v2.txt")
...
async def evaluate_v2():
    ...
    with open(os.path.join(os.path.dirname(__file__), "..", "results", "v2_run_output.json"), "w", encoding="utf-8") as f:
